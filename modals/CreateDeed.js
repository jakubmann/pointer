...
import { Modal, Text, SafeAreaView, TextInput, View, Alert } from 'react-native'
    ...
    return(
        ...
        >
            <View style={styles.common.centeredView}>
                <BlurView style={styles.common.modal}
                    intensity={90}
                    tint={'light'}
                >
                        <Text style={styles.common.text}>{edit ? 'Edit' : 'Create'} Deed</Text>
                        <TextInput
                            //name
